...
class team_batch(models.Model):
     
     team_name = models.CharField(max_length=200)
     tb_startdate = models.DateField(auto_now_add=False, auto_now=False,  null=True, blank=True)
...
class create_team(models.Model):
    name = models.CharField(max_length=200)  # this name field contain the team name from team_batch table
...
class previousTeam(models.Model):
    teamname = models.ForeignKey(create_team, on_delete=models.SET_NULL, null=True, blank=True)
...
class probation(models.Model):
    team=models.ForeignKey(create_team, on_delete=models.SET_NULL, null=True, blank=True)
...
class trainer_task(models.Model):
    ...
    correction_files = models.FileField(upload_to='images/', null=True, blank=True)

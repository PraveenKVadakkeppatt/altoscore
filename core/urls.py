...
urlpatterns = [
    ...
    re_path(r'^incompleted/(?P<id>\d+)$',views.incompleted,name='incompleted'),
    ############################################# Amal #############################################################
...
# completed projects-subeeesh -admin mod
    ...
    re_path(r'^completed_team_trainees/(?P<tnt_id>\d+)/$', views.completed_team_trainees, name='completed_team_trainees'),
